    ...
    return {
        "languages": {
            "python": {
                ...
                "features":   ["functions", "classes", "imports", "big_o",
                               "cyclomatic_complexity", "dead_code", "call_graph",
                               "circular_deps", "wasm_hints"],
                "available":  True,
            },
            "c": {
                "extensions": [".c"],
                "parser":     "tree-sitter-c",
                "features":   ["functions", "structs", "includes", "macros",
                               "big_o", "call_graph", "wasm_hints"],
                "available":  HAS_TREESITTER,
            },
            "cpp": {
                "extensions": [".cpp", ".cc", ".cxx", ".hpp", ".h"],
                "parser":     "tree-sitter-cpp",
                "features":   ["functions", "classes", "includes", "macros",
                               "big_o", "call_graph", "wasm_hints"],
                "available":  HAS_TREESITTER,
            },
            "javascript": {
                ...
                "features":   ["functions", "classes", "imports", "exports",
                               "big_o", "dead_code", "call_graph", "wasm_hints"],
                "available":  True,
            },
            "typescript": {
                "extensions": [".ts", ".tsx"],
                "parser":     "regex + AST-like",
                "features":   ["functions", "classes", "imports", "exports",
                               "interfaces", "types", "big_o", "dead_code",
                               "call_graph", "wasm_hints"],
                "available":  True,
            },
        },
        "capabilities": {
...
async def parse_project(req: ParseProjectRequest) -> dict[str, Any]:
    ...
    wasm_candidates = [
        {"file": r["filename"], "hints": r.get("wasm_hints",[])}
        for r in results
        if r.get("wasm_hints")
    ]
    ...
    return {
        ...
        "summary": (
            ...
            + (f"{len([h for h in hints if h.get('priority',0)>=4])} crítica(s)."
               if hints else "Sin candidatos detectados.")
        ),
    }