// ══════════════════════════════════════════
//  Sythrall — Explorador de carpetas (cross-browser, estilo VSCode)
...
import { persistFilesToProject, selectFile, updateSelectors, updateStats } from './app'
